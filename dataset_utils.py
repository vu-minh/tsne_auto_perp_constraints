...
def load_dataset(name='MNIST-SMALL'):
    ...
    return {
        'COIL20': load_coil20,
        'MNIST': partial(load_mnist_full, 2000),
        ...
        'COUNTRY-1999': partial(load_country, 1999),
        'COUNTRY-2013': partial(load_country, 2013),
        'COUNTRY-2014': partial(load_country, 2014),
        'COUNTRY-2015': partial(load_country, 2015),
